...
const NDT: Item[] = [
  ...
  { cat: "Industrial CT", spec: "3D CT · Metrology", name: "MQCT Series", subtitle: "Industrial Computed Tomography", desc: "Volumetric CT for dimensional metrology, porosity analysis and internal defect mapping.", image: "/assets/prod-mqct.jpg", brochure: "mqct-industrial-ct.pdf" },
