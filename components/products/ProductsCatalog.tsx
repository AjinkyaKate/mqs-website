...
const NDT: Item[] = [
  { cat: "Digital Radiography", spec: "160–450 kV · DR & CT", name: "MQX.drIS", subtitle: "Cabinet-Based Digital Radiography", desc: "Self-contained 2D inspection for small and mid-sized components, with multi-axis part handling built in.", image: "/assets/product-mqxc.jpg", href: "/products/mqx-dris", brochure: "mqxc-cabinet-dr.pdf" },
  { cat: "Industrial CT", spec: "3D CT · Metrology", name: "MQX.NeVa", subtitle: "Industrial Computed Tomography", desc: "Measurable 3D volumes for porosity classification, wall-thickness mapping and internal metrology.", image: "/assets/product-mqct.jpg", href: "/products/mqx-neva", brochure: "mqct-industrial-ct.pdf" },
  ...
  { cat: "Wheel / Shell", spec: "10″–26″ · Inline", name: "MQWR 160U Inline Wheel Inspection Solutions", subtitle: "Production Wheel Radiography", desc: "Inline radiography for alloy and steel wheels with automated defect recognition at line speed.", image: "/assets/product-wheel.png", brochure: "mqwr-160u-wheel-inspection.pdf" },
  { cat: "Digital Radiography", spec: "AI ADR · Production DR", name: "MQS.PRISM", subtitle: "Production Radiography", desc: "Production digital radiography with AI-assisted defect recognition and pass/fail calling.", image: "/assets/product-prism.png", brochure: "mqs-prism.pdf" },
  ...
  { cat: "PCB X-ray", spec: "≤0.75 µm · 2.5D", name: "MQX.tracE", subtitle: "2.5D PCB X-Ray Inspection", desc: "India’s first indigenous 2.5D PCB X-ray system for solder voids, bridging and PTH fill.", image: "/assets/product-trace.png", href: "/products/mqx-trace", brochure: "mqx-trace.pdf" },
  { cat: "PCB X-ray", spec: "Volumetric 3D", name: "MQX.tracE CT", subtitle: "3D PCB Inspection", desc: "Layer-by-layer analysis of populated boards for buried-via and interconnect failure analysis.", image: "/assets/product-trace.png", href: "/products/mqx-trace", brochure: "mqx-trace-ct.pdf" },
  { cat: "PCB X-ray", spec: "Inline · 2D / 2.5D / 3D", name: "MQX.tracE | IN-3D", subtitle: "Inline PCB X-Ray Inspection", desc: "Inline 2D / 2.5D / 3D X-ray inspection for PCB and electronic assemblies, combining high-resolution imaging and automated defect analysis directly in the production flow.", image: "/assets/product-trace-in3d.png", href: "/products/mqx-trace", brochure: "mqx-trace-in-3d.pdf" },
  ...
  { cat: "Specialised Systems", spec: "Custom-built · Automated", name: "Fuze Inspection Solutions", subtitle: "Digital Radiography for Fuzes", desc: "Custom-built digital radiography with an optional swivel mechanism for faster automated fuze inspection.", image: "/assets/product-fuze.png", href: "/contact", brochure: "fuze-inspection-system.pdf" },
  { cat: "Specialised Systems", spec: "Controlled energy · Dose", name: "MQIR 225 — X-Ray Irradiator", subtitle: "Laboratory Irradiation System", desc: "Stable, accurate laboratory irradiation in a shielded stainless-steel chamber with adjustable sample distance.", image: "/assets/product-irradiator.png", href: "/contact", brochure: "mqir-225-irradiator.pdf" },
];
...
function ProductImage() {
  return (
    <Image
      ...
      className="absolute inset-0 h-full w-full scale-[.78] object-contain p-8 lg:p-12"
    />
  );
}
