...
const NDT: Item[] = [
  ...
  { cat: "PCB X-ray", spec: "Volumetric 3D", name: "MQX.tracE 3D", subtitle: "3D PCB Inspection", desc: "Layer-by-layer analysis of populated boards for buried-via and interconnect failure analysis.", image: "/assets/product-trace.png", href: "/products/mqx-trace" },
  { cat: "PCB X-ray", spec: "Inline · 3D", name: "MQX.tracE Inline 3D", subtitle: "Inline 3D PCB Inspection", desc: "Automated 3D inspection integrated into electronics production workflows.", image: "/assets/product-trace.png", href: "/products/mqx-trace" },
